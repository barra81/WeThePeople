...
int getArrayLength(JITarrayTypes eType)
{
	...
	case JIT_ARRAY_TRADE_LOCATION:     return NUM_TRADELOCATION_TYPES;
...
const CvInfoBase* getBaseInfo(JITarrayTypes eType, int iIndex)
{
	...
	case JIT_ARRAY_TRADE_LOCATION:     return &GC.getTradeLocationInfo((TradeLocationTypes)iIndex);
...
const char* getArrayName(JITarrayTypes eType)
{
	...
	case JIT_ARRAY_TRADE_LOCATION:     return "TradeLocation";
...
const char* getArrayPrefix(JITarrayTypes eType)
{
	...
	case JIT_ARRAY_TRADE_LOCATION:     return "TRADE_LOCATION_";
